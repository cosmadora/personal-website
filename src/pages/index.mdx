...
This website is [open source](https://github.com/cosmadora/personal-website). It's an entirely static site generated with [<AstroVersion />](https://astro.build/) and [<VueVersion />](https://vuejs.org/) hosted on GitHub Pages for fun 🌷.  
