...
<Image src={portrait} alt="Portrait of Adora" />
...
This website is [open source](https://code.lila.network/adoras-projects/personal-website). It's an entirely static site generated with [<AstroVersion />](https://astro.build/) and [<VueVersion />](https://vuejs.org/) hosted on [BunnyCDN](https://bunny.net/) for performance and fun 🌷.  
  
This page makes due without any cookies or databases, utilizing isolated interactive islands to keep the web quick and usable again :)  
