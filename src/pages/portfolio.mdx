...
import LatestForgejoRelease from '@/components/portfolio/LatestForgejoRelease.vue';
import LatestGithubRelease from '@/components/portfolio/LatestGithubRelease.vue';
...
Language: `Go`  
Source: [github.com/lila-network/certwarden-deploy](https://github.com/lila-network/certwarden-deploy)  
Documentation: [certwarden-deploy.lila.network](https://certwarden-deploy.lila.network/)  
Latest Version: <LatestGithubRelease repo="lila-network/certwarden-deploy" client:visible />  
...
Latest Version: <LatestForgejoRelease repo="lila-network/mailcow-admin-aliases" client:visible />  
...
Latest Version: <LatestForgejoRelease repo="adoras-projects/ntppool-exporter" client:visible />  
...
Latest Version: <LatestForgejoRelease repo="adoras-projects/forgejo-release-proxy" client:visible />  
