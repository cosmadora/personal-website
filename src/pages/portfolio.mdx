...
import LatestForgejoRelease from '@/components/LatestForgejoRelease.vue';
...
Latest Version: <LatestForgejoRelease repo="lila-network/certwarden-deploy" client:visible />  
